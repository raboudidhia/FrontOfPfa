...
export default function Sidebar() {
  ...
  return (
    <nav className={`shadow-md h-screen p-2 flex flex-col duration-500 bg-blue-500 text-white ${open ? 'w-60' : 'w-16'}`}>

      {/* Header with Menu Toggle */}
      <div className='px-3 py-2 h-20 flex justify-between items-center'>
        {/* Optional Logo: Uncomment if you want to add a logo */}
